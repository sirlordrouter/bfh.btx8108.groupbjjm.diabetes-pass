...
-(BOOL)createDB;
-(BOOL) writeMeasurementInDB:(double)measurementValue measurementUnit:(NSString*)measurementUnit upperLimit:(double)upperLimit lowerLimit:(double)lowerLimit isBeforeMeal:(Boolean)isBeforeMeal;
